...
export class MilesightAM308Codec extends BaseDeviceCodec {
  ...
  return {
    ...
    model:        'AM308',
    description:  'Ambience Monitoring Sensor — Temperature, Humidity, PIR, Light Level, CO₂, TVOC, Pressure, PM2.5, and PM10',
    telemetryKeys: [
    ...
    commands: [
      ...
      },
      {
        type:   'set_time_zone',
        label:  'Set Time Zone',
        params: [{ key: 'time_zone', label: 'Time Zone', type: 'string' as const, required: true, default: 'UTC' }],
      },
      {
        type:   'set_tvoc_unit',
        label:  'Set TVOC Unit',
